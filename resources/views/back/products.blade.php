        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h2 class="main__logo--title"><a>Товары</a></h2>
                </div>                                                          
            </div>
        </div>
    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="header__info--link" href="{{ route('detailing', $value['id'])}}"><b>{{ $value['name'] }}</b></a></td>
                                            
                                            <td>{{ number_format($value['price'], 2, ',', ' ') }}</td>
                                            <td>{{ $value['category']['name'] }}</td>
                                            <td>
                                                <button class="primary__btn price__filter--btn" id='delete' type="button">Удалить</button>
                                            </td>   
                                        </tr>
                                        @endforeach                                        
                                    </tbody>
                                </table>
                                <p><u>Добавить новый товар</u></p>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th style="min-width: 100px; width: 100px;" bgcolor="#66CDAA">Название</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input style="min-width: 150px; width: 150px;" type="text" name="name" class="name" value="Товар"></td>
                                            <td class="col-id-no" scope="row"><textarea rows='3' cols='20' type=text name="description" class="description">Описание</textarea></td>
                                            <td><input style="min-width: 150px; width: 150px;" type="text" name="price" class="price" value="0"></td>
                                            <td>   
                                                <select id="category" style="min-width: 130px; width: 130px;" name="category" class="category">
                                                    <option selected value="1">Легкий</option>
